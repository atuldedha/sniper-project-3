...
const Banner = ({ name }) => {
  return (
    <div className="bg-pink1 pl-14 pr-8 py-10 flex items-center space-x-8 relative rounded-2xl">
      {/* left part */}
      <div className="flex flex-col items-start w-full lg:basis-1/2">
        <h1 className="text-2xl text-purple1 font-nuni font-extrabold block pb-4">
          Good morning, {name}
        </h1>
        <p className="font-nuni font-normal text-gray1 text-base block pb-8">
        ...
        <div className="flex flex-col items-start">
          <span className="font-nuni font-bold text-sm text-gray1 block pb-4">
            Helpful links:
          </span>
